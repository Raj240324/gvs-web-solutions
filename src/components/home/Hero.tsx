import { ArrowRight, X, Mail, BookOpen, Phone, ArrowLeft } from "lucide-react";
...
const Hero: React.FC = () => {
  ...
  const buttons = [
    ...
    },
    {
      ...
      hoverColor: "#d67a30",
      text: "Catalogue",
      action: () => window.open("/catalogue.pdf", "_blank"),
    },
    {
      id: "call",
    ...
    {
      id: "whatsapp",
      href: "https://wa.me/+919884001597?text=Hello%20GVS%20Controls,%20I%20have%20an%20inquiry.",
      icon: "WhatsApp",
      color: "#25D366",
      hoverColor: "#1DA851",
      text: "WhatsApp",
      action: () =>
        window.open(
          "https://wa.me/+919884001597?text=Hello%20GVS%20Controls,%20I%20have%20an%20inquiry.",
          "_blank"
        ),
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div
        className={`fixed bottom-6 right-2 z-50 transition-opacity duration-300 ${
        ...
        <AnimatePresence>
          {isExpanded && (
            <motion.div
              ...
              animate="visible"
              exit="hidden"
              className="absolute bottom-20 right-14 flex flex-col gap-3"
            >
                ...
                return (
                  <div key={button.id} className="relative">
                    <motion.button
                      onClick={() =>
                        setExpandedButton(
                          expandedButton === button.id ? null : button.id
                        )
                      }
                      ...
                      animate={{
                        scale: isMiddleButton ? [1, 1.06, 1] : [1, 1.04, 1],
                      }}
                      transition={{
                        repeat: Infinity,
                        duration: isMiddleButton ? 1.8 : 2.2,
                        ease: "easeInOut",
                      }}
                      whileHover={{
                        scale: 1.2,
                      ...
                      {expandedButton === button.id && (
                        ...
                        >
                          ...
                          >
                            ...
                            {button.text === "Catalogue" &&
                              "Download our latest catalogue."}
                            {button.text === "Call" &&
                              "Contact us directly at +91 9884001597."}
