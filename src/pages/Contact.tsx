    ...
    <main className="pt-16 sm:pt-20 md:pt-24 lg:pt-28 min-h-screen bg-gradient-to-b from-gray-50 to-gray-200 dark:from-gray-900 dark:to-gray-800">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-white to-gray-100 dark:from-gray-900 dark:to-gray-800">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {[
              { icon: <MapPin size={24} className="sm:w-8 sm:h-8" />, title: 'Our Office', content: 'No.9/14, First Floor, EWS Plot, Gudalur, Maraimalai Nagar, Chengalpattu-(District), Pin:603209', link: 'https://maps.google.com/?q=Maraimalai+Nagar,+Chengalpattu', linkText: 'View on Map' },
              { icon: <Mail size={24} className="sm:w-8 sm:h-8" />, title: 'Email Us', content: ['General: gvscontrols@gmail.com', 'Support: support@gvscontrols.com'], link: 'mailto:gvscontrols@gmail.com', linkText: 'Send an Email' },
              { icon: <Phone size={24} className="sm:w-8 sm:h-8" />, title: 'Call Us', content: ['Mobile: +91 9087772798', 'Office: No.46/1, 5th Cross Street, Bagavathy Nagar, Guduvanchery - 603202'], link: 'tel:9087772798', linkText: 'Call Now' }
            ].map((item, index) => (
              <motion.div
                key={index}
                variants={fadeInUp}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6 sm:mb-8 text-sm sm:text-base md:text-lg">We’re excited to hear from you—let’s get started!</p>
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  <div className="space-y-2">
                    <label htmlFor="name" className="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-200">Name <span className="text-red-500">*</span></label>
                    <Input
                      type="text"
                      id="name"
                      name="name"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="email" className="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-200">Email <span className="text-red-500">*</span></label>
                    <Input
                      type="email"
                      id="email"
                      name="email"
                ...
                <div className="space-y-2">
                  <label htmlFor="message" className="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-200">Message <span className="text-red-500">*</span></label>
                  <Textarea
                    id="message"
                    name="message"
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  ...
                  >
                    <span className="relative flex items-center justify-center">
                      {isSubmitting ? (
                        <>
                          <svg className="animate-spin mr-2 h-4 w-4 sm:h-5 sm:w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                          Sending...
                        </>
                      ) : isSubmitted ? (
                        <>
            ...
            >
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-2 sm:gap-4 text-gray-600 dark:text-gray-300 text-xs sm:text-sm">
                  <div className="font-medium">Monday - Friday</div><div>9:00 AM - 6:00 PM</div>
                  <div className="font-medium">Saturday</div><div>9:00 AM - 1:00 PM</div>
                  <div className="font-medium">Sunday</div><div>Closed</div>
                </div>
              </motion.div>
            </motion.div>
          </div>
        ...
        {[
          {
            ...
            link: "https://www.linkedin.com/company/gvs-controls", // Replace with your LinkedIn profile URL
            name: "LinkedIn",
            hoverColor: "#0A66C2",
          },
          {
            icon: <Facebook size={20} className="sm:w-7 sm:h-7" />,
            link: "https://www.facebook.com/gvscontrols", // Replace with your Facebook profile URL
            name: "Facebook",
            hoverColor: "#1877F2",
          },
          {
            icon: <Twitter size={20} className="sm:w-7 sm:h-7" />,
            link: "https://x.com/gvscontrols", // Replace with your X profile URL
            name: "Twitter",
            hoverColor: "#1D9BF0",
          },
          {
            icon: <Instagram size={20} className="sm:w-7 sm:h-7" />,
            link: "https://www.instagram.com/gvscontrols", // Replace with your Instagram profile URL
            name: "Instagram",
            hoverColor: "#E4405F",
          },
        ].map((social, index) => (
          <motion.a
            ...
            style={{ '--hover-color': social.hoverColor }} // Custom property for hover color
            whileHover={{
              scale: 1.15,
              rotate: 5,
